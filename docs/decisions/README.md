...
`#naming` `#odyssey-cli` `#process` `#public-mirror` `#react-compatibility`
`#release` `#skills` `#storybook` `#styling` `#superseded` `#testing` `#theming` `#tooling`
...
| 2026-06-03 | [External links announce new-tab behavior with hidden text](2026-06-03-external-links-announce-new-tab.md)                              | architecture | #icons #i18n                             | Accepted      |
...
| 2026-07-23 | [Drive reflow logic from a standalone media-query hook, not MUI breakpoints](2026-07-23-reflow-media-query-hook-over-mui-breakpoint.md) | architecture | #theming #styling                        | Accepted      |
| 2026-07-27 | [Direct-render Storybook states for VRT](2026-07-27-direct-render-stories-for-vrt.md)                                                   | testing      | #storybook #testing                      | Accepted      |
| 2026-07-27 | [Use lifecycle-based documentation layers](2026-07-27-handbook-documentation-layers.md)                                                 | docs         | #docs #contributions #public-mirror      | Accepted      |
| 2026-07-28 | [Render overlay stories open by default instead of using a play function](2026-07-28-open-by-default-overlays-in-stories.md)            | testing      | #storybook #testing                      | Accepted      |
| 2026-07-29 | [Import React-18-only hooks via a shim or the in-repo hook, not from `react`](2026-07-29-restore-react-17-compat-hooks.md)              | architecture | #react-compatibility #coding-conventions | Accepted      |
| 2026-07-30 | [Wait on Bacon via a disposable haiku subagent driving /bacon](2026-07-30-haiku-subagent-drives-bacon.md)                               | ai-workflow  | #release #bacon #subagent #tokens        | Accepted      |
