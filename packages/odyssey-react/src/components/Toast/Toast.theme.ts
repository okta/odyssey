...
export const theme: ThemeReducer = (theme) => ({
  ...
  DismissInsetBlockStart: theme.SpaceScale1,
  DismissInsetInlineEnd: theme.SpaceScale1,
  ...
  HeadingPaddingInlineEnd: theme.SpaceScale4,
  ...
  PenInsetBlockEnd: theme.SpaceScale4,
  PenInsetInlineEnd: theme.SpaceScale4,
  PenRowGap: theme.SpaceScale2,
