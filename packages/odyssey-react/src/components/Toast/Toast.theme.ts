...
export const theme: ThemeReducer = (theme) => ({
  ...
  DismissInsetBlockStart: theme.Space1,
  DismissInsetInlineEnd: theme.Space1,
  ...
  HeadingPaddingInlineEnd: theme.Space4,
  ...
  PaddingBlock: theme.Space4,
  PaddingInline: theme.Space2,
  PenInsetBlockEnd: theme.Space4,
  PenInsetInlineEnd: theme.Space4,
  PenRowGap: theme.Space2,
