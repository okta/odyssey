...
export const theme: ThemeReducer = (theme) => ({
  ...
  ContentPaddingBlockEnd: theme.Space6,
  ContentPaddingBlockStart: theme.Space4,
  ContentPaddingInline: 0,
  DialogBackgroundColor: theme.ColorBackgroundBase,
  DialogPaddingBlockEnd: 0,
  DialogPaddingBlockStart: theme.Space4,
  DialogPaddingInline: theme.Space6,
  DismissMarginBlockEnd: theme.Space1,
  FooterPaddingBlockEnd: theme.Space4,
