...
export const theme: ThemeReducer = (theme) => ({
  ...
  ContentPaddingBlockEnd: theme.SpaceScale6,
  ContentPaddingBlockStart: theme.SpaceScale4,
  ContentPaddingInline: 0,
  DialogBackgroundColor: theme.ColorBackgroundBase,
  DialogPaddingBlockEnd: 0,
  DialogPaddingBlockStart: theme.SpaceScale4,
  DialogPaddingInline: theme.SpaceScale6,
  DismissMarginBlockEnd: theme.SpaceScale1,
  FooterPaddingBlockEnd: theme.SpaceScale4,
