...
export interface TableSortHeaderCellProps
  ...
  /**
   * Callback executed when the sort header fires a change event
   * @param {Object} event the event object
   * @param {string} value the string value of the input
   */
  onSort?: (value: "asc" | "desc" | "unsorted") => void;
}

export const TableSortHeaderCell = withTheme(
  theme,
  styles
)(
...
TableSortHeaderCell.displayName = "TableSortHeaderCell";
