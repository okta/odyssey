...
```sh
$ yarn add --dev @okta/odyssey-babel-loader
```

Reference the loader within your webpack configuration:
    ...
    rules: [
      {
        ...
        use: {
          loader: "@okta/odssey-babel-loader",
        },
      },
    ],
  },
...
All of the [configuration options][1] available to `babel-loader` are available
here as well. Additionally, an `include` option accepts an array of regular
expressions or escaped regular expression strings to target style modules
that may be using unconventional file extensions.
