    ...
    return (
      ...
      >
        <>
          <path
            clipRule="evenodd"
            d="M14.667 14.667h-1.334V1.333h1.334zm-4.943-6H.667V7.333h9.057L6.195 3.805l.943-.943 4.29 4.29.01.01c.057.057.124.124.178.187a1 1 0 0 1 .197.342 1 1 0 0 1 0 .618 1 1 0 0 1-.197.342 3 3 0 0 1-.178.187l-.01.01-4.29 4.29-.943-.943z"
            fill="currentColor"
            fillRule="evenodd"
          />
        </>
