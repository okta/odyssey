    ...
    return (
      ...
      >
        <>
          <path
            clipRule="evenodd"
            d="M14.667 14.667h-1.334V1.333h1.334zm-11.724-6H12V7.333H2.943L6.47 3.805l-.942-.943-4.29 4.29-.01.01a4 4 0 0 0-.178.187 1 1 0 0 0-.197.342 1 1 0 0 0 0 .618 1 1 0 0 0 .197.342c.054.063.121.13.177.187l.011.01 4.29 4.29.942-.943z"
            fill="currentColor"
            fillRule="evenodd"
          />
        </>
