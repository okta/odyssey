    ...
    return (
      ...
      >
        <>
          <path
            clipRule="evenodd"
            d="m5.529 9.529 6.861-6.862H6.667V1.333h6.815c.08 0 .174 0 .258.007.097.008.235.028.38.102a1 1 0 0 1 .438.437c.074.146.094.284.102.381.007.084.007.178.007.258v6.815h-1.334V3.61l-6.862 6.862zm5.163 3.827V8.124l1.333-1.361v7.926H1.349V3.977h7.886L7.874 5.311H2.683v8.045z"
            fill="currentColor"
            fillRule="evenodd"
          />
        </>
