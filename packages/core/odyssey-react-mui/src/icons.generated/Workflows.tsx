...
export type WorkflowsIconProps = SvgIconNoChildrenProps;

const WorkflowsIcon = forwardRef<SVGSVGElement, WorkflowsIconProps>(
  (props, ref) => {
    return (
      <SvgIcon
        fill="none"
...
const MemoizedWorkflowsIcon = memo(WorkflowsIcon);
MemoizedWorkflowsIcon.displayName = "WorkflowsIcon";

export { MemoizedWorkflowsIcon as WorkflowsIcon };
