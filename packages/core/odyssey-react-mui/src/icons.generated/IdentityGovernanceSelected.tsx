  ...
  return (
    ...
    >
      <>
        <path
          clipRule="evenodd"
          d="m12.943 3.333 1.528 1.529.472.471-.472.472-2.333 2.333-.471.472-.472-.472L9.667 6.61l-1.74 1.739a4 4 0 1 1-.943-.943l1.74-1.74.471-.47 2.334-2.334.471-.471.862-.862.943.942z"
          fill="currentColor"
          fillRule="evenodd"
        />
      </>
