    ...
    return (
      ...
      >
        <>
          <path
            clipRule="evenodd"
            d="M8 .667c-2.97 0-5.313 2.37-5.576 5.266-.198 2.19-.529 4.171-1.06 5.868l-.272.866h3.639A3.3 3.3 0 0 0 8 15.333a3.3 3.3 0 0 0 3.269-2.666h3.639l-.272-.866c-.531-1.697-.862-3.679-1.06-5.868C13.313 3.038 10.97.667 8 .667m1.891 12H6.11A1.97 1.97 0 0 0 8 14a1.97 1.97 0 0 0 1.891-1.333M3.752 6.053C3.958 3.781 5.782 2 8 2s4.042 1.78 4.248 4.053c.171 1.894.443 3.676.866 5.28H2.886c.423-1.604.695-3.386.866-5.28"
            fill="currentColor"
            fillRule="evenodd"
          />
        </>
