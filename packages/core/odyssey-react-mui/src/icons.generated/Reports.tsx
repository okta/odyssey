    ...
    return (
      ...
      >
        <>
          <path
            clipRule="evenodd"
            d="M10.25 1.333h-.667v3.334H5.125V8H.667v3.094c0 .49 0 .898.027 1.231.028.347.09.67.245.977a2.5 2.5 0 0 0 1.093 1.092c.305.156.63.217.976.245.333.028.741.028 1.231.028h7.521c.49 0 .899 0 1.232-.027.347-.029.67-.09.976-.246a2.5 2.5 0 0 0 1.093-1.092c.156-.306.217-.63.245-.977.027-.333.027-.74.027-1.231V1.333zm.667 12V2.667H14v8.4c0 .524 0 .877-.023 1.15-.021.264-.06.393-.104.48-.112.219-.29.397-.51.51-.086.043-.215.082-.48.104-.272.022-.625.022-1.15.022zM6.458 6v7.333h3.084V6zM2 9.333v1.734c0 .524 0 .877.023 1.15.021.264.06.393.104.48.112.219.29.397.51.51.086.043.215.082.48.104.272.022.625.022 1.15.022h.816v-4z"
            fill="currentColor"
            fillRule="evenodd"
          />
        </>
