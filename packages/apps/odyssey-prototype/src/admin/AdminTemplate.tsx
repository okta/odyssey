...
//   1. Create the component in src/admin/pages/
//   2. Import it here and add a route entry to ADMIN_ROUTES
//   3. Add a nav item to src/admin/shell/AdminSideNavConfig.tsx
...
export const ADMIN_ROUTES: RouteObject[] = [
  // Index: redirect to /admin/directory/groups
  { index: true, element: <Navigate replace to="/admin/directory/groups" /> },
  ...
  { path: "directory/ai-agents", element: <StubPage title="AI Agents" /> },
  {
  ...
  { path: "directory/devices", element: <StubPage title="Devices" /> },
  {
  ...
  // Customizations
  { path: "customizations/brands", element: <StubPage title="Brands" /> },
  {
  ...
  { path: "customizations/other", element: <StubPage title="Other" /> },
  ...
  // Security
  { path: "security/general", element: <StubPage title="General" /> },
  {
  ...
  { path: "security/networks", element: <StubPage title="Networks" /> },
  {
  ...
  { path: "reports/system-log", element: <StubPage title="System Log" /> },
  {
  ...
  { path: "reports/rate-limits", element: <StubPage title="Rate Limits" /> },

  // Settings
  { path: "settings/account", element: <StubPage title="Account" /> },
  { path: "settings/features", element: <StubPage title="Features" /> },
  { path: "settings/downloads", element: <StubPage title="Downloads" /> },
];
