...
import { ADMIN_SIDE_NAV_CONFIG } from "./AdminSideNavConfig";
...
/**
 * Route layout component for the Admin Console app.
 * Locked — do not modify directly. To add nav items, edit AdminSideNavConfig.tsx.
 */
export const AdminShell = (props: AdminShellProps) => (
  <AppShell
    {...props}
    appName="Admin Console"
    selectedAppName="saasure"
    sideNavConfig={ADMIN_SIDE_NAV_CONFIG}
