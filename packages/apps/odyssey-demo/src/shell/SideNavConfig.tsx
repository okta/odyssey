...
// SIDE_NAV_CONFIG
export const SIDE_NAV_CONFIG: SideNavItem[] = [
  {
    id: "nav-dashboard",
    label: "Dashboard",
  ...
  },
  {
    ...
    nestedNavItems: [
      ...
      },
      {
        ...
        label: "AI Agents",
        href: "/directory/ai-agents",
      },
      {
        id: "nav-directory-mcp-servers",
        label: "MCP Servers",
        href: "/directory/mcp-servers",
      },
      {
        id: "nav-directory-service-accounts",
        label: "Service Accounts",
        href: "/directory/service-accounts",
      },
      {
        id: "nav-directory-realms",
        label: "Realms",
        href: "/directory/realms",
      },
      {
    ...
    nestedNavItems: [
      {
        ...
        href: "/identity-governance/access-certifications",
      },
      {
      ...
      },
      {
        ...
        href: "/identity-governance/resource-collections",
      },
      {
        id: "nav-ig-settings",
        label: "Settings",
        href: "/identity-governance/settings",
      },
    ],
  },
  {
