...
const icons: IconData[] = [
  ...
  { name: "AppsIcon", use: "" },
  { name: "AppsSelectedIcon", use: "" },
  { name: "ArrowBottomIcon", use: "" },
  ...
  { name: "CustomizationsIcon", use: "" },
  { name: "CustomizationsSelectedIcon", use: "" },
  ...
  { name: "DirectorySelectedIcon", use: "" },
  ...
  { name: "HomeIcon", use: "" },
  { name: "HomeSelectedIcon", use: "" },
  { name: "IdentityGovernanceIcon", use: "" },
  { name: "IdentityGovernanceSelectedIcon", use: "" },
  ...
  { name: "ReportsIcon", use: "" },
  { name: "ReportsSelectedIcon", use: "" },
  { name: "ResetIcon", use: "" },
  { name: "ResumeIcon", use: "" },
  { name: "SadIcon", use: "" },
  { name: "SameIcon", use: "" },
  { name: "SearchIcon", use: "To search for something" },
  { name: "SecurityIcon", use: "" },
  { name: "SecuritySelectedIcon", use: "" },
  { name: "SendIcon", use: "" },
  { name: "ServerIcon", use: "" },
  { name: "SettingsIcon", use: "To edit user or app settings" },
  { name: "SettingsSelectedIcon", use: "" },
  { name: "ShowIcon", use: "To show something" },
  { name: "SparkleIcon", use: "" },
  { name: "SubtractIcon", use: "To subtract or remove" },
  { name: "SyncIcon", use: "" },
  { name: "ThumbsDownIcon", use: "" },
  { name: "ThumbsUpIcon", use: "" },
  { name: "UnlockIcon", use: "" },
  { name: "UploadIcon", use: "" },
  ...
  { name: "WorkflowsIcon", use: "" },
  { name: "WorkflowsSelectedIcon", use: "" },
];
