...
export const Placement: Story = {
  ...
  render: () => (
    <>
      <Tooltip ariaType="label" placement="top" text="Top">
        <Tag label="Bow" />
      </Tooltip>

      <Tooltip ariaType="label" placement="left" text="Left">
        <Tag label="Stern" />
      </Tooltip>

      <Tooltip ariaType="label" placement="bottom" text="Bottom">
        <Tag label="Port" />
      </Tooltip>

      <Tooltip ariaType="label" placement="right" text="Right">
        <Tag label="Starboard" />
      </Tooltip>
    </>
  ),
