...
Begin by creating a [`webpack.config.js` config file][2] at the root of your project:
...
Begin by creating a [`.browserslistrc` config file][3] at the root of your project:
...
Begin by creating a [`babel.config.js` config file][5] the root of your project:
...
Begin by creating a [`.postcssrc.js` config file][6] at the root of your project:
