...
<Meta title="Guidelines/Elements" />

# Elements

Currently, this page acts as an inventory of HTML elements previously styled via global CSS. As we move forward, these use cases will be covered by Box, Reset, or Text components.

As those components support specific use cases, their examples will be moved to the appropriate parent.
...
<figure class="docs-example">
  <div class="docs-example--rendered">
    <p>
      ...
      <abbr title="Frontend">FE</abbr> developer, you should checkout our dev
      docs.
    </p>
  </div>
</figure>
...
<figure class="docs-example">
  <div class="docs-example--rendered">
    ...
    <address>
      <a href="mailto:press@okta.com">press@okta.com</a>
      <br />
  ...
  <div class="docs-example--rendered">
    <details>
      ...
      <p>
        ...
        technology. It’s a service that gives employees, customers, and partners
        secure access to the tools they need to do their most important work.
      </p>
    </details>
  </div>
</figure>
...
<figure class="docs-example">
  <div class="docs-example--rendered">
    <p>
      Do you <em>really</em> want to see that movie?
    </p>
  </div>
</figure>
...
<figure class="docs-example">
  <div class="docs-example--rendered">
    ...
    <ul>
      <li>
        <mark>Button</mark> labels should clearly indicate what action the user
        is taking, e.g. "Add User" instead of "Submit".
      </li>
      <li>
      ...
      <fieldset class="ods-fieldset">
        <div class="ods-fieldset-flex">
          <input
            ...
            required
          />
          <label class="ods-label" for="outputJD">
            Jelly Donuts (Amount)
          </label>
        </div>
      </fieldset>
      <fieldset class="ods-fieldset">
        <div class="ods-fieldset-flex">
          ...
          <label class="ods-label" for="outputOF">
            Old Fashioned Donuts (Amount)
          </label>
        </div>
      </fieldset>
      <fieldset class="ods-fieldset">
        <div class="ods-fieldset-flex">
          <label class="ods-label" for="outputTotal">
            Total Donuts
          </label>
          <output
            aria-live="polite"
...
<figure class="docs-example">
  <div class="docs-example--rendered">
    <pre>
      <code>const fruitColors = apple: 'red', banana: 'yellow'</code>
    </pre>
  </div>
</figure>
...
<figure class="docs-example">
  <div class="docs-example--rendered">
    ...
    <p>
      <strong>This dish is now SOLD OUT!</strong>
    </p>
  </div>
</figure>
...
<figure class="docs-example">
  <div class="docs-example--rendered">
    <p>
      ...
      <samp>
        Press <kbd>F5</kbd> to refresh bakery
      </samp>
      .
    </p>
  </div>
...
<figure class="docs-example">
  <div class="docs-example--rendered">
    <p>
      ...
      <strong>please don't run.</strong>
    </p>
  </div>
</figure>
