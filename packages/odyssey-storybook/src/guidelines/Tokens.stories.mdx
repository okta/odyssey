...
<figure class="ods-table--figure">
  <figcaption class="ods-table--figcaption">Semantic Colors</figcaption>
  <table class="ods-table">
    ...
    <tbody>
      <tr>
        ...
        <td>
          <span class="sample-token sample-token--color-primary-light"></span>
        </td>
        <td>Blue 300</td>
      </tr>
      <tr>
        ...
        <td>
          <span class="sample-token sample-token--color-primary-base"></span>
        </td>
        <td>Blue 500</td>
      </tr>
      <tr>
        ...
        <td>
          <span class="sample-token sample-token--color-primary-dark"></span>
        </td>
        <td>Blue 900</td>
      </tr>
      <tr>
        ...
        <td>
          <span class="sample-token sample-token--color-danger-light"></span>
        </td>
        <td>Red 300</td>
      </tr>
      <tr>
        ...
        <td>
          <span class="sample-token sample-token--color-danger-base"></span>
        </td>
        <td>Red 500</td>
      </tr>
      <tr>
        ...
        <td>
          <span class="sample-token sample-token--color-danger-dark"></span>
        </td>
        <td>Red 900</td>
      </tr>
    </tbody>
...
<figure class="ods-table--figure">
  <figcaption class="ods-table--figcaption">Focus Ring</figcaption>
  <table class="ods-table">
    <thead>
      <tr>
        <th scope="column">Token Name</th>
    ...
    <tbody>
      <tr>
        <td>
          <code>$focus-ring-primary</code>
        </td>
        <td>
          <span class="sample-token sample-token--color-primary-outline"></span>
        </td>
        <td>Blue 300</td>
      </tr>
      <tr>
        <td>
          <code>$focus-ring-danger</code>
        </td>
        <td>
          <span class="sample-token sample-token--color-danger-outline"></span>
        </td>
        <td>Red 300</td>
      </tr>
    </tbody>
...
<figure class="ods-table--figure">
  <figcaption class="ods-table--figcaption">Type</figcaption>
  <table class="ods-table">
    <thead>
      <tr>
        <th scope="column">Token Name</th>
    ...
    <tbody>
      <tr>
        ...
        <td>
          <span class="sample-token--text-body">Aa</span>
        </td>
        <td>Gray 900</td>
      </tr>
      <tr>
        ...
        <td>
          <span class="sample-token--text-danger">Aa</span>
        </td>
        <td>Red 500</td>
      </tr>
      <tr>
        ...
        <td>
          <span class="sample-token--text-heading">Aa</span>
        </td>
        <td>Gray 900</td>
      </tr>
      <tr>
        ...
        <td>
          <span class="sample-token--text-sub">Aa</span>
        </td>
        <td>Gray 600</td>
      </tr>
    </tbody>
...
<figure class="ods-table--figure">
  <figcaption class="ods-table--figcaption">Spacing</figcaption>
  <table class="ods-table">
    <thead>
      <tr>
        <th scope="column">Token Name</th>
