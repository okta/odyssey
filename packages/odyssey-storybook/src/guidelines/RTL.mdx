...
Browsers have not settled on a standard RTL syntax for 4-value shorthands. Currently, using standard 4-value shorthands (`margin: 4px 3px 2px 1px`) will be parsed as physical CSS by the browser. Things to watch out for when adding styles for margin and padding:
...
Box properties need to be logical, not positional.
