...
<Canvas>
  <Story id="legacy-components-table--default" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-table--sorted" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-table--empty-table" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-table--row-heading" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-table--row-grouping" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-table--supported-content" />
</Canvas>
