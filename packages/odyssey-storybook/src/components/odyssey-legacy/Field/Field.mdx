...
<Canvas>
  <Story id="legacy-components-textinput--kitchen-sink" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-field--field-hint" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-field--field-error" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-textarea--default" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-radio--default" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-textinput--optional" />
</Canvas>
...
If additional disclosures or warnings are required, an [Infobox](?path=/docs/components-alerts-infobox--info#infobox) may be more appropriate.
