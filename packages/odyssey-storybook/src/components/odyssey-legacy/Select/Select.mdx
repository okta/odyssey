...
<Canvas>
  <Story id="legacy-components-select--default" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-select--multiple" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-select--disabled" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-select--optional" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-select--group" />
</Canvas>
