...
<Canvas>
  <Story id="legacy-components-checkbox--default" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-checkbox--disabled" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-checkbox--invalid" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-checkbox--indeterminate" />
</Canvas>
