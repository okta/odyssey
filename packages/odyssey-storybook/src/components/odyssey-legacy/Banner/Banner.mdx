...
<Canvas>
  <Story id="legacy-components-alerts-banner--info" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-alerts-banner--danger" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-alerts-banner--caution" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-alerts-banner--with-link" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-alerts-banner--dismissible" />
</Canvas>
