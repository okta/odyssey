...
<Canvas>
  <Story id="legacy-components-alerts-infobox--info" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-alerts-infobox--danger" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-alerts-infobox--caution" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-alerts-infobox--success" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-alerts-infobox--with-link-inline" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-alerts-infobox--with-link" />
</Canvas>
