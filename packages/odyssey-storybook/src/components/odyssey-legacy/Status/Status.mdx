...
<Canvas>
  <Story id="legacy-components-status--neutral" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-status--success" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-status--caution" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-status--danger" />
</Canvas>
...
<Canvas>
  <Story id="legacy-components-status--with-label-hidden" />
</Canvas>
