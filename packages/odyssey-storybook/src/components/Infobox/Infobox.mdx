...
<Canvas>
  <Story id="components-alerts-infobox--info" />
</Canvas>
...
<Canvas>
  <Story id="components-alerts-infobox--danger" />
</Canvas>
...
<Canvas>
  <Story id="components-alerts-infobox--caution" />
</Canvas>
...
<Canvas>
  <Story id="components-alerts-infobox--success" />
</Canvas>
...
<Canvas>
  <Story id="components-alerts-infobox--with-link-inline" />
</Canvas>
...
<Canvas>
  <Story id="components-alerts-infobox--with-link" />
</Canvas>
...
<Canvas className="sb-do">
  <Story id="components-alerts-infobox--form-do" />
...
<Canvas className="sb-dont">
  <Story id="components-alerts-infobox--table-dont" />
