...
<Canvas>
  <Story id="components-alerts-banner--info" />
</Canvas>
...
<Canvas>
  <Story id="components-alerts-banner--danger" />
</Canvas>
...
<Canvas>
  <Story id="components-alerts-banner--caution" />
</Canvas>
...
<Canvas>
  <Story id="components-alerts-banner--with-link" />
</Canvas>
...
<Canvas>
  <Story id="components-alerts-banner--dismissible" />
</Canvas>
