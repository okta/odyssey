...
<Canvas>
  <Story id="mui-components-text-input--default" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-text-input--multiline" />
</Canvas>

### Hints

<Canvas>
  <Story id="mui-components-text-input--hint" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-text-input--tel" />
</Canvas>

<Canvas>
  <Story id="mui-components-text-input--adornment" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-text-input--optional" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-text-input--disabled" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-text-input--read-only" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-text-input--invalid" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-text-input--email" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-text-input--password" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-text-input--search" />
</Canvas>
