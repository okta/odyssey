...
<Canvas>
  <Story id="mui-components-alerts-banner--info" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-alerts-banner--error" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-alerts-banner--warning" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-alerts-banner--with-link" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-alerts-banner--dismissible" />
</Canvas>
