...
Default.argTypes = {
  name: {
    defaultValue: "alerttrianglefilled",
    control: { type: "select" },
  },
  title: {
...
const meta: Array<{ name: keyof typeof iconDictionary; use: string }> = [
  { name: "addcircle", use: "--" },
  { name: "add", use: "--" },
  { name: "alertcirclefilled", use: "--" },
  { name: "alertcircle", use: "--" },
  { name: "alerttrianglefilled", use: "--" },
  { name: "anchor", use: "--" },
  { name: "arrowdown", use: "--" },
  { name: "arrowleft", use: "--" },
  ...
  { name: "copy", use: "--" },
  { name: "dangerdiamondfilled", use: "--" },
  { name: "dangerdiamond", use: "--" },
  { name: "delete", use: "--" },
  { name: "deny", use: "--" },
  { name: "devices", use: "--" },
