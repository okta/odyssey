...
<Canvas>
  <Story id="mui-components-tooltip--default" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-tooltip--icon" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-tooltip--disabled" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-tooltip--placement" />
</Canvas>
