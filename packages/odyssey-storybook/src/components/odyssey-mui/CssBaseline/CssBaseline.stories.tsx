...
const CodeTemplate: Story = () => {
  return (
    <ScopedCssBaseline>
      <p>
        The <code>pop()</code> array method removes the last element of an array
...
export const abbr = AbbrTemplate.bind({});
abbr.args = {};

export const address = AddressTemplate.bind({});
address.args = {};

export const blockquote = BlockquoteTemplate.bind({});
blockquote.args = {};

export const cite = CiteTemplate.bind({});
cite.args = {};

export const code = CodeTemplate.bind({});
code.args = {};

export const del = DelTemplate.bind({});
del.args = {};

export const details = DetailsTemplate.bind({});
details.args = {};

export const dfn = DfnTemplate.bind({});
dfn.args = {};

export const dfnWAbbr = DfnWAbbrTemplate.bind({});
dfnWAbbr.args = {};

export const dl = DlTemplate.bind({});
dl.args = {};

export const em = EmTemplate.bind({});
em.args = {};

export const emEm = EmEmTemplate.bind({});
emEm.args = {};

export const figure = FigureTemplate.bind({});
figure.args = {};

export const hr = HrTemplate.bind({});
hr.args = {};

export const ins = InsTemplate.bind({});
ins.args = {};

export const kbd = KbdTemplate.bind({});
kbd.args = {};

export const mark = MarkTemplate.bind({});
mark.args = {};
...
export const q = QTemplate.bind({});
q.args = {};

export const s = STemplate.bind({});
s.args = {};
...
export const summary = DetailsTemplate.bind({});
summary.args = {};

export const sup = SupTemplate.bind({});
sup.args = {};

export const ul = UlTemplate.bind({});
ul.args = {};

export const Var = VarTemplate.bind({});
Var.args = {};
