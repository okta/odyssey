...
<Meta title="MUI Components/Menu Button" anchor />
...
<Canvas>
  <Story of={Stories.ButtonVariant} />
</Canvas>
...
<Canvas>
  <Story of={Stories.WithDestructive} />
</Canvas>
