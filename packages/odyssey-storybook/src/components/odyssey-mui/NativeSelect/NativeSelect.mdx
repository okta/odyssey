...
<Canvas>
  <Story id="mui-components-forms-nativeselect--default" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-forms-nativeselect--default-disabled" />
</Canvas>

<Canvas>
  <Story id="mui-components-forms-nativeselect--default-error" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-forms-nativeselect--default-grouped" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-forms-nativeselect--multi" />
</Canvas>
