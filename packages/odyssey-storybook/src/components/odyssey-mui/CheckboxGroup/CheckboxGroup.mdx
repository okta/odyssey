...
<Canvas>
  <Story id="mui-components-forms-checkboxgroup--single" />
</Canvas>

<Canvas>
  <Story id="mui-components-forms-checkboxgroup--group" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-forms-checkboxgroup--checked" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-forms-checkboxgroup--disabled" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-forms-checkboxgroup--error" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-forms-checkboxgroup--mixed-error" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-forms-checkboxgroup--indeterminate" />
</Canvas>
