...
<Canvas>
  <Story id="mui-components-forms-checkbox--single" />
</Canvas>

<Canvas>
  <Story id="mui-components-forms-checkbox--group" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-forms-checkbox--checked" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-forms-checkbox--disabled" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-forms-checkbox--error" />
</Canvas>
...
<Canvas>
  <Story id="mui-components-forms-checkbox--indeterminate" />
</Canvas>
