...
import * as PreparingAPullRequestStories from "./PreparingAPullRequest.stories";

<Meta of={PreparingAPullRequestStories} />
...
8.  Go to [the repository](https://github.com/okta/odyssey) and [make a Pull Request](https://docs.github.com/en/free-pro-team@latest/github/collaborating-with-issues-and-pull-requests/creating-a-pull-request).

9.  Oktanauts should [create an associated JIRA card](https://github.com/okta/odyssey/issues/new/choose) for any pull requests they open.
