...
Placeholder for guidelines surrounding:

- Writing copy within documentation (e.g. sentence casing, example format)
- Guide to writing CSF stories vs inline MDX stories
- Use SB tables unless you are documenting an Odyssey table
