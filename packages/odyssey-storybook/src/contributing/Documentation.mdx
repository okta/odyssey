...
<dd>
  This section includes any guidelines required for compliance as well as design
  rationale already leveraged to ensure compliance - both "please do this" and
  "we do this because".
</dd>
...
<dd>
  This section is rare today, but should include examples and rationale similar
  to the Accessibility section.
</dd>
...
<dd>
  This should include any notes about use or cultural considerations, as well as
  whether the component is lacking globalization support in some regard.
</dd>
...
<dd>
  This section has two optional children: Related Components and Further Reading
</dd>
...
<dd>
  Again, included in some places, always optional, but could provide additional
  rationale or education for our users.
</dd>
